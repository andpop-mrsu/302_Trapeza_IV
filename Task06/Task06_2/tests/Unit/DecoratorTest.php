...
namespace trapeza\Tests;

use PHPUnit\Framework\TestCase;
use trapeza\Task062\EconomyRoom;
use trapeza\Task06_2\StandardRoom;
use trapeza\Task06_2\SuiteRoom;
use trapeza\Task06_2\InternetDecorator;
use trapeza\Task06_2\BreakfastDecorator;
use trapeza\Task06_2\FoodDeliveryDecorator;
use trapeza\Task06_2\SofaDecorator;
